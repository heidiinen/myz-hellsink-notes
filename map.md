...
**H6**
- Bloodthirsty dogs, dealt with in a later session
...
**J4**
- A high, skeleton-like structure, attached to the ground with metal chains

The ground is covered in fractured concrete. There are low buildings, partially collapsed. The air has a sour smell that sticks to your nose and throat. There's a high, skeleton like structure that can be used to scout the area.
There's an abandoned pipe that seemed good for camping overnight.
...
**K4**
- Two automaton remains

Thrash and scattered ruins everywhere. The houses here are fully identical, but the level of destruction varies.
There are two automatons that were defeated. Their remains were hidden for further use.
